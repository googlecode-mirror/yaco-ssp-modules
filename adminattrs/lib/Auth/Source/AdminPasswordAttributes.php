 ...
 * @version $Id$
 */
class sspmod_adminattrs_Auth_Source_AdminPasswordAttributes extends sspmod_core_Auth_UserPassBase {
	...
	protected function login($username, $password) {
		...
		$attrs = array();
		$attrs['user'] = array('admin');
		$attrs = array_merge($attrs, $config->getArray('attrs', array()));
