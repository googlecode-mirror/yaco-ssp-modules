...
class sspmod_attributevalidator_Utilities {
	...
	public static function validateAttributes($attrs, $required_attrs, $recommended_attrs, $optional_attrs) {
		...
		return array($required, $recommended, $optional, $unknown, $validates);
	}
}
