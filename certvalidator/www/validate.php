...
if(array_key_exists('x509Cert', $_POST) && ($_POST['x509Cert']!=NULL)  ) {
	...
	$result = sspmod_certvalidator_CertValidator::validateCert($x509Cert);
...
//Login Page
$t = new SimpleSAML_XHTML_Template($config, 'certvalidator:validate.php', 'certvalidator:certvalidator'); //(configuracion, template, diccionario)
